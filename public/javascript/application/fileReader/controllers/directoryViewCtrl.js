...
angular
    .module('wakemeup')
    .controller('DirectoryViewCtrl', DirectoryViewCtrl);

    DirectoryViewCtrl.$inject = ['$rootScope', '$scope', '$state', '$stateParams', '$filter', 'Directory', 'Player', 'EventNames', 'Socket', 'SafeApply'];

    function DirectoryViewCtrl ($rootScope, $scope, $state, $stateParams, $filter, Directory, Player, EventNames, Socket, SafeApply) {
